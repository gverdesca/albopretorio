...
public class AlbopretorioApp {

    private static final Logger log = LoggerFactory.getLogger(AlbopretorioApp.class);

    private final Environment env;

    public AlbopretorioApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes albopretorio.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AlbopretorioApp.class);
